...
#ifndef __cplusplus_cli		// Something strange about Asar's functions being defined multiple times when compiled under CLI even though Patch.hpp only *declares* stuff.  I don't even know.
#include "Patch.hpp"
#endif

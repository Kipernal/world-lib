...
template <typename inputIteratorType, typename outputIteratorType>
outputIteratorType decompressLZ3(inputIteratorType compressedDataStart, inputIteratorType dataEnd, outputIteratorType out, int *compressedSize, int *decompressedSize)
{
